...
int main()
{
  ...
  // 創建視窗對象
  GLFWwindow *window = glfwCreateWindow(800, 600, "test_07", NULL, NULL);
  if (window == NULL)
  {
  ...
  Shader ourShader(".//src//test_07_cool_triangle//shader//vertex.glsl", 
  ".//src//test_07_cool_triangle//shader//fragment.glsl");
  //vertex(頂點)輸入
  //Normalized coor.(-1,1)
  float vertices[] = {
